//
//  UICollectionView+PlaceHeader.m
//  StudyTarget
//
...
#import "UICollectionView+PlaceHeader.h"
#import "PlaceHeaderview.h"
#import "NSObject+Swizzling.h"
@implementation UICollectionView (PlaceHeader)
...
- (void) checkEmpty
{
    ...
    for (NSInteger i = 0; i <= sections; i++) {
        //获取当前TableView各分区的行数
        NSInteger rows = [dataSource collectionView:self numberOfItemsInSection:sections];        if (rows) {
